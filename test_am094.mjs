...
assert.match(source, /const EXTENSION_VERSION = '0\.9\.4'/);
...
console.log(`Anchor Memory 0.9.4 summary-lock regression checks passed (${elapsed.toFixed(1)}ms entity stress).`);
